...
public class ActivitiController {
	...
	public ModelAndView start(@RequestParam("id") String id, ModelAndView mav) {
	...
	public ModelAndView complete(ModelAndView mav, @RequestParam("id") String id){
	...
	public void graphics(@RequestParam("definitionId") String definitionId, @RequestParam("instanceId") String instanceId, @RequestParam("taskId") String taskId, ModelAndView mav, HttpServletResponse response)
			throws IOException {
		...
		if (taskId != null) {
			...
			cmd = new ProcessInstanceDiagramCmd(	task.getProcessInstanceId(), engine);
		}
