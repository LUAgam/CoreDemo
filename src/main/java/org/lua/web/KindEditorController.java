...
//		String savePath = application.getRealPath("/") + "editK/attached/";
//
//		// 文件保存目录URL
//		String saveUrl = request.getContextPath() + "/editK/attached/";
//
//		// 定义允许上传的文件扩展名
...
//			writer.println(objectMapper.writeValueAsString(getError(Constant.ERROR_KINDEDITORCONTROLLER_CHOOSE_FILES)));
//			return;
//
//		}
//		// 检查目录
...
//					.writeValueAsString(getError(Constant.ERROR_KINDEDITORCONTROLLER_NO_PROFESSIONAL)));
//			return;
//		}
//
...
//			writer.println(objectMapper.writeValueAsString(getError(Constant.ERROR_KINDEDITORCONTROLLER_NAME_INACCURATE)));
//			return;
//		}
//		// 创建文件夹
//		savePath += dirName + "/";
...
//					writer.println(objectMapper
//							.writeValueAsString(getError(Constant.ERROR_KINDEDITORCONTROLLER_FILES_TOOBIG)));
//				}
//				// 检查扩展名
...
//						.contains(fileExt)) {
//					writer.println(objectMapper
//							.writeValueAsString(getError(Constant.ERROR_KINDEDITORCONTROLLER_FILES_NAME_INACCURATE
//									+ extMap.get(dirName) + Constant.KINDEDITORCONTROLLER_FORM)));
//					return;
//				}
//
...
//				} catch (Exception e) {
//					writer.println(objectMapper
//							.writeValueAsString(getError(Constant.ERROR_KINDEDITORCONTROLLER_UPLOAD_FILES)));
//				}
//
...
//		String rootPath = application.getRealPath("/") + "editK/attached/";
//		// 根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
//		String rootUrl = request.getContextPath() + "/editK/attached/";
//		// 图片扩展名
