...
<jvnav:pagetitle>
	${i18n_dashboardCalendar}
</jvnav:pagetitle>

<jvnav:breadcrumb>
	<jvnav:breadcrumbitem title="${i18n_dashboard}" url="/admin" />
	<jvnav:breadcrumbitem title="${i18n_dashboardCalendar}" active="true" />
</jvnav:breadcrumb>
	...
	<jvlayout:col length="12">
		<div class="metro-nav">
               <div class="metro-nav-block  nav-block-blue">
                   <a href="<c:url value='/admin/profile/calendar/write'/>" data-original-title="">
...
<jvlayout:row>
	...
	<div class="span12 responsive" data-tablet="span12 fix-margin"
		data-desktop="span12">
				...
				.fullCalendar(
						{
							...
							events : function(start, end, callback) {
								...
								$.ajax({
									...
									"url" : "<c:url value='/admin/profile/calendar'/>",
									"dataType" : "json",
										...
										.dialog({
											...
											buttons : {
												"edit" : {
													...
													"callback" : function() {
														var urls = "<c:url value='/admin/profile/calendar/edit/" +calEvent.id+"'/>";
														location.href = urls;
													}
												},
												"delete" : {
													...
													"callback" : function() {
														$
																.ajax({
																	"type" : "POST",
																	"url" : "<c:url value='/admin/profile/calendar/delete/"+calEvent.id+"'/>",
																	"success" : function() {
																		calendar
																				.fullCalendar(
																						'removeEvents',
