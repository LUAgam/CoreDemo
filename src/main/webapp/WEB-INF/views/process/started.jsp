...
<spring:message code="process.graphic" var="i18N_processGraphic"/>
<spring:message code="process.started" var="i18N_processStarted"/>
<spring:message code="process.defineID" var="i18N_processDefineID"/>
<spring:message code="process.exampleID" var="i18N_processExampleID"/>
...
<body>
	...
	<div style="margin: 0 auto; width: 400px; padding-top: 50px;">
		<h2>${i18N_processStarted}</h2>
		<table width="400px;">
			<thead>
				<tr>
					<th>${i18N_processExampleID}</th>
					<th>${i18N_processDefineID}</th>
			...
			<tbody>
				<c:forEach var="temp" items="${list}">
					<tr>
						<td>${temp.id}</td><td>${temp.processDefinitionId}</td><td> <a href="../process/graphics?instanceId=${temp.id}">${i18N_processGraphic}</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
