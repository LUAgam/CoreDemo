...
<%@ taglib prefix="jvpagetable" tagdir="/WEB-INF/tags/pagetable"%>
			...
			<jvpagetable:table htmlTableId="assigneeTodoTaskTable" page="${assigneeTodoTaskPage}" url="/dialog/task/assignee/list">
				...
				<jvpagetable:OptionColumn>
					<button onclick="other('${ctx}/admin/profile/task/doTask/${entity.processInstanceId}/${entity.taskId}')" class="btn btn-small btn-warning" type="button">
						办理
					</button>
					
					<script type="text/javascript">
					function other(q) {
						if(confirm("确定要办理该条待办任务吗？"))
					    {
