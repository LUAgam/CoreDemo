...
<jvlayout:row>
	...
	<jvpanel:panelNoTools color="green" title="故障处理方法" icon="icon-table">
		<jvpagetable:table url="/dialog/faultMethod/list" page="${faultMethodList}" htmlTableId="faultMethodListTable">
			<jvpagetable:searchTextItem id="search_no" title="编号" key="no" operat="LIKE" placeholder="" value="${SEARCH_no}"></jvpagetable:searchTextItem>		
				<jvpagetable:searchTextItem id="search_name" title="名称" key="name" operat="LIKE" placeholder="" value="${SEARCH_name}"></jvpagetable:searchTextItem>		
				...
				<jvpagetable:columnheader>处理方法</jvpagetable:columnheader>
