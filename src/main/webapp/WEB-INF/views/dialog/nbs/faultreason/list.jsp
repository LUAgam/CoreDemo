...
<spring:message code="fault.reason" var="i18n_faultReason"/>
...
<jvlayout:row>
	...
	<jvpanel:panelNoTools color="green" title="${i18n_faultReason}" icon="icon-table">
		<jvpagetable:table url="/dialog/faultreason/list" page="${faultReasonList}" htmlTableId="faultreasonListTable">
			
			<jvpagetable:searchTextItem id="search_causeCode" title="${i18n_commonCode}" key="causeCode" operat="LIKE" placeholder="${i18n_commonCode}代码" value="${SEARCH_causeCode}"></jvpagetable:searchTextItem>		
			...
			<jvpagetable:column id="causeCode">${entity.causeCode}</jvpagetable:column>
