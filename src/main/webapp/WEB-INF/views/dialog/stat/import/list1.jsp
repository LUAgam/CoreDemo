...
<spring:message code="stat.daily.paramName" var="i18N_sdParamName"/>
...
<jvlayout:row>
	<jvlayout:col length="12">
		...
		<jvpagetable:table url="/dialog/import/list/${flag}" page="${importTransferList}" htmlTableId="importTransferList0Table">
				
				<jvpagetable:searchTextItem id="dailyListTable_search_line.lineName" title="${i18N_scLine}" key="line.lineName" 
					operat="LIKE" placeholder="" value="${SEARCH_line_lineName}"></jvpagetable:searchTextItem>
				<jvpagetable:searchTextItem id="dailyListTable_search_parameter.name" title="${i18N_sdParamName}" key="parameter.name" 
					operat="LIKE" placeholder="" value="${SEARCH_parameter_name}"></jvpagetable:searchTextItem>
				<jvpagetable:searchDatefield id="importTransferList0Table_search_timeStr" title="${i18N_cTime}" key="timeStr" value="${SEARCH_timeStr}"></jvpagetable:searchDatefield>
				
				
				<jvpagetable:checkColumnheader></jvpagetable:checkColumnheader>
				<jvpagetable:checkColumn></jvpagetable:checkColumn>
				
				<jvpagetable:columnheader>${i18N_scParamName}</jvpagetable:columnheader>
				<jvpagetable:column id="parameter">${entity.parameter.name}</jvpagetable:column> 
				...
				<jvpagetable:columnheader>${i18N_cValue}</jvpagetable:columnheader>
				<jvpagetable:column id="val">${entity.val}</jvpagetable:column>
