...
<jvlayout:row>
	<jvlayout:col length="12">
			...
			<jvpagetable:table url="/dialog/CarCondition/list/${flag}" page="${carConditionList}" htmlTableId="carConditionAListTable">
				...
				<jvpagetable:columnheader>${i18N_scaraArea}</jvpagetable:columnheader>
				<jvpagetable:column id="siding">${entity.siding}</jvpagetable:column>
				
				<jvpagetable:columnheader>${i18N_scarrEmpty}</jvpagetable:columnheader>
				<jvpagetable:column id="loadNull">${entity.loadNull}</jvpagetable:column>
