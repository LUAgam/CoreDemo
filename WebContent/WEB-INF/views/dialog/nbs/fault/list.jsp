...
<spring:message code="fault.message" var="i18n_faultMessage"/>
...
<jvlayout:row>
	...
	<jvpanel:panelNoTools color="green" title="${i18n_faultMessage}" icon="icon-table">
		<jvpagetable:table url="/dialog/fault/list" page="${faultList}" htmlTableId="faultListTable">
			<jvpagetable:searchTextItem id="search_symptomCode" title="${i18n_commonCode}" key="symptomCode" operat="LIKE" placeholder="代码" value="${SEARCH_symptomCode}"></jvpagetable:searchTextItem>		
			...
			<jvpagetable:column id="symptomCode">${entity.symptomCode}</jvpagetable:column>
