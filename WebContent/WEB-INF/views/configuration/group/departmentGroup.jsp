...
<jvnav:breadcrumb>
	...
	<jvnav:breadcrumbitem title="岗位部门管理" active="true" />
</jvnav:breadcrumb>

<jvlayout:row>
	<jvlayout:col length="12">
		<jvpanel:panel color="green" title="部门信息列表" icon="icon-th-large">
			...
			<form name="departmentListTableForm" action="${ctx}/admin/auth/group/saveDep/${group.id }" method="POST">
				<input type="hidden" name="groupId" value="${group.id }" /> &nbsp;&nbsp;
				<button class="btn btn-primary" id="btn_submit" type="submit">
					<i class="icon-ok"></i>保存
				</button>
				<br>


				<table id="departmentListTable" class="table table-striped table-bordered dataTable" aria-describedby="departmentListTable-table_info">
					<thead>
						<tr>
							...
							<th>编号</th>
							<th>${i18n_commonName}</th>
							<th>${i18n_departmentParent}</th>
							<th>${i18n_commonDescroption}</th>
							<th>排序</th>
						</tr>
					</thead>
