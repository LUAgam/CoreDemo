	...
	<jvlayout:row>
		<jvlayout:col length="12">
			...
			<jvform:form id="eventform" action="/admin/profile/allcalendar/write">	
				...
				<jvform:hidden id="recipientId" value="${event.recipientId}"></jvform:hidden>
				<jvform:textfield id="recipientStr" title="人员" size="xlarge"	value="${event.recipientStr}" readonly="true"></jvform:textfield>
